...
fig.suptitle("Target 1: Quality Total Cover", fontsize=20, y=0.95)
...
ax3.set_title('c. Estimated NDVI values equivalent to meeting Target 1', loc='left', fontdict={'fontsize': 16}, weight='bold')
ax3.axis('off')
