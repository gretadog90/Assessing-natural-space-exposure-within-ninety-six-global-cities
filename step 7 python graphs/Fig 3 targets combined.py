...
ax1.set_title('a. Quality Total Cover',fontsize=12, weight='bold', loc='left')         
ax1.legend().remove()
...
b=sns.stripplot(data = c40_t2,
              ...
              hue = 'Region', jitter=False, 
              palette=color_dict).set(xlabel='Proportion of population with access',
                    ylabel='', yticks=[])      
ax2.set_title('b. Equitable Spatial Distribution',fontsize=12, weight='bold', loc='left')         

ax2.axvline(0.7, ls='--', c='midnightblue')

ax2.legend().remove()

filename=data_folder+'graphs/Targets combined.svg' 
