...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 12 15:36:50 2023
...
gdf = gpd.GeoDataFrame(c40_t1, geometry="centroid")

#%% make graph
fig=plt.figure(figsize=(18, 12))
plt.subplots_adjust(hspace=0.25)
#fig, (ax1, ax2, ax3) = plt.subplots()
#fig.suptitle("Quality Total Cover Regression Fitstats and Results", fontsize=18, y=0.93)
...
ax1.set_title('A. Coefficient of determination', loc='left', fontdict={'fontsize': 15})
...
ax2.set_title('B. Root mean square error', loc='left', fontdict={'fontsize': 15})
...
ax3=gdf.plot(column='ndvip_30', cmap='cool', ax=ax3, marker="o",markersize=65)
ax3.set_title('C. Predicted NDVI Values', loc='left', fontdict={'fontsize': 15})
...
cbar.set_label('NDVI', labelpad=.0001, fontsize=15)
cbar.ax.tick_params(labelsize=14)

filename=output+'target1 model results.png' 
